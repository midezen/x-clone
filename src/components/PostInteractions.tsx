...
const PostInteractions = () => {
  return (
    <div className="flex items-center justify-between my-2 gap-6 lg:gap-16 text-textGray">
      <div className="flex items-center justify-between flex-1">
        ...
        <div className="flex items-center gap-2 group cursor-pointer">
          ...
          <span className="group-hover:text-iconGreen text-sm">32</span>
        </div>{" "}
        {/* LIKE */}
        <div className="flex items-center gap-2 group cursor-pointer">
          <svg
          ...
          <span className="group-hover:text-iconPink text-sm">300</span>
        </div>
      </div>
